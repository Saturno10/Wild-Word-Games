...
void juanagra(DicPalabras &d){
    string palabra;
    cin >> palabra;

    cout << "Juanagrama: " << convertirPalabraMayuscula(palabra) << " ->" << d.juanagra(convertirPalabraMayuscula(palabra)) << endl;
...
void alargapalabras(DicPalabras &d){
    ...
    cin >> palabra;
    palabra = convertirPalabraMayuscula(palabra);
    string alargada = d.alarga(palabra);
    cout << "Alarga: "<< palabra << " ->";
    if (!alargada.empty()){
        cout << " " << alargada << endl;
    } else cout << endl;
